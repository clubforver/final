...
<body>
	...
	<div class="header" id="home">
		<div class="container">
			<div class="head">
			<div class="logo">
				<a href="index.html"><img src="images/logo.png" alt=""  height="70px" width="410"/></a>
	...
	<!-- script-for-menu -->
	<!--start-banner-->
	 <form method="post" action="Valid_user.jsp">
	<div class="specials">
		<div class="container">
		...
		<div class="container">
			<div class="special-main">
				...
				<div class="col-md-6 special-left">
					<p>We're dedicated to the financial services industry. Our experts focus on the industryâs unique issues to deliver real value and create your competitive advantage. We believe in high-touch account management centered on your needs at all times, during change, during growth and during streamlining.</p>
					<P></P>
